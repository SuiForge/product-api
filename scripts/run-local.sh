...
nohup env \
  ...
  VERTICAL_INDEX_API_BASE_URL="${VERTICAL_INDEX_API_BASE_URL:-}" \
  VERTICAL_INDEX_API_KEY="${VERTICAL_INDEX_API_KEY:-}" \
  VERTICAL_INDEX_API_TIMEOUT="${VERTICAL_INDEX_API_TIMEOUT:-5s}" \
  DEEPBOOK_API_BASE_URL="${DEEPBOOK_API_BASE_URL:-}" \
  DEEPBOOK_API_TOKEN="${DEEPBOOK_API_TOKEN:-}" \
  DEEPBOOK_API_TIMEOUT="${DEEPBOOK_API_TIMEOUT:-5s}" \
